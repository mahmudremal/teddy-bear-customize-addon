...
defined('TEDDY_BEAR_CUSTOMIZE_ADDON_BUILD_IMG_PATH') || define('TEDDY_BEAR_CUSTOMIZE_ADDON_BUILD_IMG_PATH', untrailingslashit(TEDDY_BEAR_CUSTOMIZE_ADDON_DIR_PATH ) . '/assets/build/src/img');

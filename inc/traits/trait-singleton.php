...
namespace TEDDYBEAR_CUSTOMIZE_ADDON\inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the `TEDDY_BEAR_CUSTOMIZE_ADDON_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf( 'TEDDY_BEAR_CUSTOMIZE_ADDON_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores

...
/* harmony import */ var _img_dubido_certificate_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/dubido_certificate.png */ "./src/img/dubido_certificate.png");
/* harmony import */ var _img_certificate_email_sky_jpg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/certificate_email_sky.jpg */ "./src/img/certificate_email_sky.jpg");
/* harmony import */ var _img_certificate_email_header_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../img/certificate_email_header.png */ "./src/img/certificate_email_header.png");
  ...
  _createClass(Ask, [{
    ...
    value: function init_ask_4_teddy_info(thisClass) {
      ...
      if ((_window = window) !== null && _window !== void 0 && _window.teddyNameRequired) {
        ...
        document.querySelectorAll('.fwp-outfit__certificate .btn[data-certificate]').forEach(function (button) {
    ...
    value: function get_ask_template(items, thisClass) {
      ...
      items.forEach(function (item) {
        var _item$info$teddyname, _item$info, _item$info$teddybirth, _item$info2, _item$info$recieverna, _item$info3, _item$info$createdby, _item$info4;
        var body = document.createElement('div');
        body.classList.add('askteddyinfo__body');
        var fields = [{
          label: 'Teddy name',
          type: 'text',
          name: 'item-' + item.item_id + '[teddyname]',
          default: (_item$info$teddyname = (_item$info = item.info) === null || _item$info === void 0 ? void 0 : _item$info.teddyname) !== null && _item$info$teddyname !== void 0 ? _item$info$teddyname : ''
        }, {
          label: 'Birth date',
          type: 'date',
          name: 'item-' + item.item_id + '[teddybirth]',
          default: (_item$info$teddybirth = (_item$info2 = item.info) === null || _item$info2 === void 0 ? void 0 : _item$info2.teddybirth) !== null && _item$info$teddybirth !== void 0 ? _item$info$teddybirth : ''
        }, {
          label: 'Reciever\'s Name',
          type: 'text',
          name: 'item-' + item.item_id + '[recievername]',
          default: (_item$info$recieverna = (_item$info3 = item.info) === null || _item$info3 === void 0 ? void 0 : _item$info3.recievername) !== null && _item$info$recieverna !== void 0 ? _item$info$recieverna : ''
        }, {
          label: 'Created with love by',
          type: 'text',
          name: 'item-' + item.item_id + '[createdby]',
          default: (_item$info$createdby = (_item$info4 = item.info) === null || _item$info4 === void 0 ? void 0 : _item$info4.createdby) !== null && _item$info$createdby !== void 0 ? _item$info$createdby : ''
        }];
...
var DOWNLOADS = {
        ...
        if (pops && DOWNLOADS.lastAttached.length >= 1) {
          ...
          pops.innerHTML = "\n                    <table>\n                        <thead>\n                            <tr>\n                                <th>".concat((_DOWNLOADS$i18n$produ = (_DOWNLOADS$i18n2 = DOWNLOADS.i18n) === null || _DOWNLOADS$i18n2 === void 0 ? void 0 : _DOWNLOADS$i18n2.productname) !== null && _DOWNLOADS$i18n$produ !== void 0 ? _DOWNLOADS$i18n$produ : 'Product title', "</th>\n                                <td>").concat((_DOWNLOADS$i18n$data = (_DOWNLOADS$i18n3 = DOWNLOADS.i18n) === null || _DOWNLOADS$i18n3 === void 0 ? void 0 : _DOWNLOADS$i18n3.data) !== null && _DOWNLOADS$i18n$data !== void 0 ? _DOWNLOADS$i18n$data : 'Data', "</td>\n                            </tr>\n                        </thead>\n                        <tbody>\n                            \n                            ").concat(DOWNLOADS.lastAttached.map(function (order_item) {
            return "\n                            <tr>\n                                <th>\n                                    <a class=\"attachment__title\" href=\"".concat(order_item.product_edit, "\" target=\"_blank\">").concat(order_item.product, "</a> x ").concat(order_item.quantity, "\n                                </th>\n                                <td>\n                                    ").concat(Object.keys(order_item.attached).map(function (key) {
              var _order_item$attached$;
              return order_item.attached[key] && ((_order_item$attached$ = order_item.attached[key]) === null || _order_item$attached$ === void 0 ? void 0 : _order_item$attached$.length) >= 1 ? "\n                                        <span class=\"attachment__type\">".concat(key, "</span>\n                                        <div class=\"attachment__row\">\n                                            ").concat(order_item.attached[key].map(function (link) {
  ...
  get_merged_download_file_name: function get_merged_download_file_name(link, type, order_item) {
    switch (type) {
      case 'voices':
        link = "recorded-".concat(order_item.order_item_id, "-").concat(order_item.order_id, ".").concat(link.split('.').pop());
        break;
      default:
        link = link.split('/').pop();
        break;
...
/* harmony import */ var wavesurfer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! wavesurfer.js */ "./node_modules/wavesurfer.js/dist/wavesurfer.esm.js");
...
/* harmony import */ var _ask__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ask */ "./src/js/backend/ask.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  var FWPListivoBackendJS = /*#__PURE__*/function () {
    ...
    _createClass(FWPListivoBackendJS, [{
      ...
      value: function setup_hooks() {
        ...
        this.Ask = new _ask__WEBPACK_IMPORTED_MODULE_12__["default"](this);
      ...
      key: "init_wavesurfer__",
      value: function init_wavesurfer__() {
      ...
      value: function init_tooltips() {
        var thisClass = this;
        document.querySelectorAll('.fwp-outfit__image:not([data-handled-tippy])').forEach(function (el) {
          el.dataset.handledTippy = true;
          Object(tippy_js__WEBPACK_IMPORTED_MODULE_6__["default"])(el, {
            allowHTML: true,
            content: '\
        ...
        document.querySelectorAll('.fwppopspopup-open:disabled').forEach(function (el) {
          var _thisClass$i18n$globa, _thisClass$i18n2;
          Object(tippy_js__WEBPACK_IMPORTED_MODULE_6__["default"])(el.parentElement, {
            content: (_thisClass$i18n$globa = (_thisClass$i18n2 = thisClass.i18n) === null || _thisClass$i18n2 === void 0 ? void 0 : _thisClass$i18n2.globallydefined) !== null && _thisClass$i18n$globa !== void 0 ? _thisClass$i18n$globa : 'This product is globally defined and until disabling forceful definition, you can\'t customize this popup.'
          });
        });
        document.querySelectorAll('.tippy-tooltip:not([data-handled-tippy])').forEach(function (el) {
          var _el$dataset$tippyCont, _el$dataset3;
          el.dataset.handledTippy = true;
          Object(tippy_js__WEBPACK_IMPORTED_MODULE_6__["default"])(el, {
            content: (_el$dataset$tippyCont = (_el$dataset3 = el.dataset) === null || _el$dataset3 === void 0 ? void 0 : _el$dataset3.tippyContent) !== null && _el$dataset$tippyCont !== void 0 ? _el$dataset$tippyCont : false
          });
        });
      }
    }, {
        ...
        if (do_repeater) {
          ...
          document.querySelectorAll('[id^="teddy-name-"]').forEach(function (el) {
            ...
            el.nextElementSibling.addEventListener('click', function (event) {
              var _thisClass$i18n$rusur, _thisClass$i18n3;
              var message = (_thisClass$i18n$rusur = (_thisClass$i18n3 = thisClass.i18n) === null || _thisClass$i18n3 === void 0 ? void 0 : _thisClass$i18n3.rusure) !== null && _thisClass$i18n$rusur !== void 0 ? _thisClass$i18n$rusur : 'Are you sure?';
              if (confirm(message)) {
      ...
      value: function initRandTeddyBadge() {
        ...
        if (do_repeater) {
          ...
          document.querySelectorAll('[id^="teddy-badge-"]').forEach(function (el) {
            el.nextElementSibling.querySelector('.description').innerHTML = _frontend_icons__WEBPACK_IMPORTED_MODULE_8__["default"].trash;
            el.nextElementSibling.addEventListener('click', function (event) {
              var _thisClass$i18n$rusur2, _thisClass$i18n4;
              var message = (_thisClass$i18n$rusur2 = (_thisClass$i18n4 = thisClass.i18n) === null || _thisClass$i18n4 === void 0 ? void 0 : _thisClass$i18n4.rusure) !== null && _thisClass$i18n$rusur2 !== void 0 ? _thisClass$i18n$rusur2 : 'Are you sure?';
              if (confirm(message)) {
                var _el$dataset4;
                if ((_el$dataset4 = el.dataset) !== null && _el$dataset4 !== void 0 && _el$dataset4.group) {
                  ['enable', 'label', 'backgound', 'textcolor'].forEach(function (row) {
...
var PROMPTS = {
  ...
  do_field: function do_field(field, data) {
    var _data$placeholder, _PROMPTS$i18n$placeho, _PROMPTS$i18n23, _PROMPTS$i18n$placeho2, _PROMPTS$i18n24, _data$type5, _data$placeholder2, _PROMPTS$i18n$placeho3, _PROMPTS$i18n25, _PROMPTS$i18n$placeho4, _PROMPTS$i18n26, _data$label, _PROMPTS$i18n$input_l, _PROMPTS$i18n27, _data$description, _PROMPTS$i18n$placeho5, _PROMPTS$i18n28, _data$placeholder3, _PROMPTS$i18n$placeho6, _PROMPTS$i18n29, _PROMPTS$i18n$add_new, _PROMPTS$i18n30, _data$groups, _data$label2, _PROMPTS$i18n$input_l2, _PROMPTS$i18n31, _data$description2, _PROMPTS$i18n$placeho7, _PROMPTS$i18n32, _data$placeholder4, _PROMPTS$i18n$placeho8, _PROMPTS$i18n33, _PROMPTS$i18n$add_new2, _PROMPTS$i18n34, _data$options, _data$type6, _data$product, _PROMPTS$i18n$product, _PROMPTS$i18n35, _data$type7, _data$duration, _PROMPTS$i18n$duratio, _PROMPTS$i18n36, _data$teddy_name, _PROMPTS$i18n$teddy_n, _PROMPTS$i18n37, _data$teddy_birth, _PROMPTS$i18n$teddy_b, _PROMPTS$i18n38, _data$teddy_sender, _PROMPTS$i18n$teddy_s, _PROMPTS$i18n39, _data$teddy_reciever, _PROMPTS$i18n$teddy_r, _PROMPTS$i18n40;
    ...
    if (field.steptitle) {
      var _data$stepicon, _PROMPTS$i18n$svg_ico, _PROMPTS$i18n9, _PROMPTS$i18n$give_sv, _PROMPTS$i18n10, _data$steptitle, _PROMPTS$i18n$popup_s, _PROMPTS$i18n11, _PROMPTS$i18n$popup_s2, _PROMPTS$i18n12;
      PROMPTS.lastfieldID++;
      ...
      input.setAttribute('value', (_data$stepicon = data === null || data === void 0 ? void 0 : data.stepicon) !== null && _data$stepicon !== void 0 ? _data$stepicon : '');
      input.placeholder = (_PROMPTS$i18n$svg_ico = (_PROMPTS$i18n9 = PROMPTS.i18n) === null || _PROMPTS$i18n9 === void 0 ? void 0 : _PROMPTS$i18n9.svg_icon) !== null && _PROMPTS$i18n$svg_ico !== void 0 ? _PROMPTS$i18n$svg_ico : 'SVG icon';
      label = document.createElement('label');
      label.classList.add('form-label');
      label.setAttribute('for', input.id);
      label.innerHTML = (_PROMPTS$i18n$give_sv = (_PROMPTS$i18n10 = PROMPTS.i18n) === null || _PROMPTS$i18n10 === void 0 ? void 0 : _PROMPTS$i18n10.give_svg_text_conts) !== null && _PROMPTS$i18n$give_sv !== void 0 ? _PROMPTS$i18n$give_sv : 'Your SVG text content here.';
      ...
      input.placeholder = (_PROMPTS$i18n$popup_s = (_PROMPTS$i18n11 = PROMPTS.i18n) === null || _PROMPTS$i18n11 === void 0 ? void 0 : _PROMPTS$i18n11.popup_step_text) !== null && _PROMPTS$i18n$popup_s !== void 0 ? _PROMPTS$i18n$popup_s : 'PopUp Step text';
      label = document.createElement('label');
      label.classList.add('form-label');
      label.setAttribute('for', input.id);
      label.innerHTML = (_PROMPTS$i18n$popup_s2 = (_PROMPTS$i18n12 = PROMPTS.i18n) === null || _PROMPTS$i18n12 === void 0 ? void 0 : _PROMPTS$i18n12.popup_steptext_desc) !== null && _PROMPTS$i18n$popup_s2 !== void 0 ? _PROMPTS$i18n$popup_s2 : 'PopUp Step text not more then 10 characters.';
      fieldset.appendChild(label);
      fieldset.appendChild(input);
      div.appendChild(fieldset);
    }
    if (field.headerbg) {
      var _PROMPTS$i18n$select_, _PROMPTS$i18n13, _data$headerbgurl, _data$headerbgurl2, _PROMPTS$i18n$popup_s3, _PROMPTS$i18n14, _data$headerbgurl3, _PROMPTS$i18n$select_2, _PROMPTS$i18n15, _PROMPTS$i18n$select_3, _PROMPTS$i18n16, _data$headerbg, _data$headerbgurl4;
      PROMPTS.lastfieldID++;
      fieldset = document.createElement('div');
      fieldset.classList.add('form-group');
      ...
      input.type = 'button';
      input.innerHTML = (_PROMPTS$i18n$select_ = (_PROMPTS$i18n13 = PROMPTS.i18n) === null || _PROMPTS$i18n13 === void 0 ? void 0 : _PROMPTS$i18n13.select_image) !== null && _PROMPTS$i18n$select_ !== void 0 ? _PROMPTS$i18n$select_ : 'Select image';
      ...
      input.placeholder = (_PROMPTS$i18n$popup_s3 = (_PROMPTS$i18n14 = PROMPTS.i18n) === null || _PROMPTS$i18n14 === void 0 ? void 0 : _PROMPTS$i18n14.popup_subheading_text) !== null && _PROMPTS$i18n$popup_s3 !== void 0 ? _PROMPTS$i18n$popup_s3 : 'PopUp Sub-heading text';
      ...
      input.dataset.innertext = (_PROMPTS$i18n$select_2 = (_PROMPTS$i18n15 = PROMPTS.i18n) === null || _PROMPTS$i18n15 === void 0 ? void 0 : _PROMPTS$i18n15.select_image) !== null && _PROMPTS$i18n$select_2 !== void 0 ? _PROMPTS$i18n$select_2 : 'Select image';
      label = document.createElement('p');
      label.classList.add('text-muted');
      label.setAttribute('for', 'thefield' + PROMPTS.lastfieldID);
      input.id = 'thefield' + PROMPTS.lastfieldID;
      label.innerHTML = (_PROMPTS$i18n$select_3 = (_PROMPTS$i18n16 = PROMPTS.i18n) === null || _PROMPTS$i18n16 === void 0 ? void 0 : _PROMPTS$i18n16.select_image_desc) !== null && _PROMPTS$i18n$select_3 !== void 0 ? _PROMPTS$i18n$select_3 : 'Select an image for popup header. It should be less weight, vertical and optimized.';
      hidden = document.createElement('input');
      hidden.type = 'hidden';
    ...
    if (field.heading) {
      var _data$heading, _PROMPTS$i18n$popup_h, _PROMPTS$i18n17, _PROMPTS$i18n$popup_h2, _PROMPTS$i18n18;
      PROMPTS.lastfieldID++;
      fieldset = document.createElement('div');
      fieldset.classList.add('form-group');
      input = document.createElement('input');
      ...
      input.placeholder = (_PROMPTS$i18n$popup_h = (_PROMPTS$i18n17 = PROMPTS.i18n) === null || _PROMPTS$i18n17 === void 0 ? void 0 : _PROMPTS$i18n17.popup_heading_text) !== null && _PROMPTS$i18n$popup_h !== void 0 ? _PROMPTS$i18n$popup_h : 'PopUp Heading text';
      label = document.createElement('label');
      label.classList.add('form-label');
      label.setAttribute('for', 'thefield' + PROMPTS.lastfieldID);
      label.innerHTML = (_PROMPTS$i18n$popup_h2 = (_PROMPTS$i18n18 = PROMPTS.i18n) === null || _PROMPTS$i18n18 === void 0 ? void 0 : _PROMPTS$i18n18.popup_heading) !== null && _PROMPTS$i18n$popup_h2 !== void 0 ? _PROMPTS$i18n$popup_h2 : 'PopUp Heading';
      fieldset.appendChild(label);
      fieldset.appendChild(input);
      div.appendChild(fieldset);
    }
    if (field.subtitle) {
      var _data$subtitle, _PROMPTS$i18n$popup_s4, _PROMPTS$i18n19, _PROMPTS$i18n$popup_s5, _PROMPTS$i18n20;
      PROMPTS.lastfieldID++;
      fieldset = document.createElement('div');
      fieldset.classList.add('form-group');
      input = document.createElement('input');
      ...
      input.placeholder = (_PROMPTS$i18n$popup_s4 = (_PROMPTS$i18n19 = PROMPTS.i18n) === null || _PROMPTS$i18n19 === void 0 ? void 0 : _PROMPTS$i18n19.popup_subheading_text) !== null && _PROMPTS$i18n$popup_s4 !== void 0 ? _PROMPTS$i18n$popup_s4 : 'PopUp Sub-heading text';
      label = document.createElement('label');
      label.classList.add('form-label');
      label.setAttribute('for', input.id);
      label.innerHTML = (_PROMPTS$i18n$popup_s5 = (_PROMPTS$i18n20 = PROMPTS.i18n) === null || _PROMPTS$i18n20 === void 0 ? void 0 : _PROMPTS$i18n20.popup_subheading) !== null && _PROMPTS$i18n$popup_s5 !== void 0 ? _PROMPTS$i18n$popup_s5 : 'PopUp Sub Heading';
      fieldset.appendChild(label);
      fieldset.appendChild(input);
      div.appendChild(fieldset);
    }
    ...
    if (true) {
      var _data$required, _PROMPTS$i18n$popup_s6, _PROMPTS$i18n21, _PROMPTS$i18n$require, _PROMPTS$i18n22;
      PROMPTS.lastfieldID++;
      fieldset = document.createElement('div');
      ...
      input.placeholder = (_PROMPTS$i18n$popup_s6 = (_PROMPTS$i18n21 = PROMPTS.i18n) === null || _PROMPTS$i18n21 === void 0 ? void 0 : _PROMPTS$i18n21.popup_subheading_text) !== null && _PROMPTS$i18n$popup_s6 !== void 0 ? _PROMPTS$i18n$popup_s6 : 'PopUp Sub-heading text';
      label = document.createElement('label');
      label.classList.add('form-label');
      label.setAttribute('for', input.id);
      label.innerHTML = (_PROMPTS$i18n$require = (_PROMPTS$i18n22 = PROMPTS.i18n) === null || _PROMPTS$i18n22 === void 0 ? void 0 : _PROMPTS$i18n22.required) !== null && _PROMPTS$i18n$require !== void 0 ? _PROMPTS$i18n$require : 'Required';
      fieldset.appendChild(label);
      fieldset.appendChild(input);
      div.appendChild(fieldset);
    }
    ...
    switch (field.type) {
      case 'textarea':
        ...
        input.placeholder = (_PROMPTS$i18n$placeho = (_PROMPTS$i18n23 = PROMPTS.i18n) === null || _PROMPTS$i18n23 === void 0 ? void 0 : _PROMPTS$i18n23.placeholder_text) !== null && _PROMPTS$i18n$placeho !== void 0 ? _PROMPTS$i18n$placeho : 'Placeholder text';
        input.id = 'thefield' + PROMPTS.lastfieldID;
        label = document.createElement('label');
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho2 = (_PROMPTS$i18n24 = PROMPTS.i18n) === null || _PROMPTS$i18n24 === void 0 ? void 0 : _PROMPTS$i18n24.placeholder_text) !== null && _PROMPTS$i18n$placeho2 !== void 0 ? _PROMPTS$i18n$placeho2 : 'Placeholder text';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        div.appendChild(fieldset);
        break;
      ...
      case 'range':
        ...
        input.name = 'placeholder';
        input.placeholder = (_PROMPTS$i18n$placeho3 = (_PROMPTS$i18n25 = PROMPTS.i18n) === null || _PROMPTS$i18n25 === void 0 ? void 0 : _PROMPTS$i18n25.placeholder_text) !== null && _PROMPTS$i18n$placeho3 !== void 0 ? _PROMPTS$i18n$placeho3 : 'Placeholder text';
        label = document.createElement('label');
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho4 = (_PROMPTS$i18n26 = PROMPTS.i18n) === null || _PROMPTS$i18n26 === void 0 ? void 0 : _PROMPTS$i18n26.placeholder_ordefault) !== null && _PROMPTS$i18n$placeho4 !== void 0 ? _PROMPTS$i18n$placeho4 : 'Placeholder / Default value';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        div.appendChild(fieldset);
        break;
      case 'outfit':
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$input_l = (_PROMPTS$i18n27 = PROMPTS.i18n) === null || _PROMPTS$i18n27 === void 0 ? void 0 : _PROMPTS$i18n27.input_label) !== null && _PROMPTS$i18n$input_l !== void 0 ? _PROMPTS$i18n$input_l : 'Input label';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        input = document.createElement('input');
        input.classList.add('form-control', 'form-control-' + field.type);
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho5 = (_PROMPTS$i18n28 = PROMPTS.i18n) === null || _PROMPTS$i18n28 === void 0 ? void 0 : _PROMPTS$i18n28.placeholder_text) !== null && _PROMPTS$i18n$placeho5 !== void 0 ? _PROMPTS$i18n$placeho5 : 'Field descriptions.';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        PROMPTS.lastfieldID++;
        input = document.createElement('input');
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho6 = (_PROMPTS$i18n29 = PROMPTS.i18n) === null || _PROMPTS$i18n29 === void 0 ? void 0 : _PROMPTS$i18n29.placeholder_text) !== null && _PROMPTS$i18n$placeho6 !== void 0 ? _PROMPTS$i18n$placeho6 : 'Placeholder text';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        /**
         * Reapeter fields
        ...
        input.innerHTML = (_PROMPTS$i18n$add_new = (_PROMPTS$i18n30 = PROMPTS.i18n) === null || _PROMPTS$i18n30 === void 0 ? void 0 : _PROMPTS$i18n30.add_new_group) !== null && _PROMPTS$i18n$add_new !== void 0 ? _PROMPTS$i18n$add_new : 'Add new group';
      ...
      case 'checkbox':
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$input_l2 = (_PROMPTS$i18n31 = PROMPTS.i18n) === null || _PROMPTS$i18n31 === void 0 ? void 0 : _PROMPTS$i18n31.input_label) !== null && _PROMPTS$i18n$input_l2 !== void 0 ? _PROMPTS$i18n$input_l2 : 'Input label';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        input = document.createElement('input');
        input.classList.add('form-control', 'form-control-' + field.type);
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho7 = (_PROMPTS$i18n32 = PROMPTS.i18n) === null || _PROMPTS$i18n32 === void 0 ? void 0 : _PROMPTS$i18n32.placeholder_text) !== null && _PROMPTS$i18n$placeho7 !== void 0 ? _PROMPTS$i18n$placeho7 : 'Field descriptions.';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        PROMPTS.lastfieldID++;
        input = document.createElement('input');
        ...
        label.classList.add('form-label');
        label.setAttribute('for', input.id);
        label.innerHTML = (_PROMPTS$i18n$placeho8 = (_PROMPTS$i18n33 = PROMPTS.i18n) === null || _PROMPTS$i18n33 === void 0 ? void 0 : _PROMPTS$i18n33.placeholder_text) !== null && _PROMPTS$i18n$placeho8 !== void 0 ? _PROMPTS$i18n$placeho8 : 'Placeholder text';
        fieldset.appendChild(label);
        fieldset.appendChild(input);
        /**
         * Reapeter fields
        ...
        input.type = 'button';
        input.dataset.order = 0;
        input.innerHTML = (_PROMPTS$i18n$add_new2 = (_PROMPTS$i18n34 = PROMPTS.i18n) === null || _PROMPTS$i18n34 === void 0 ? void 0 : _PROMPTS$i18n34.add_new_option) !== null && _PROMPTS$i18n$add_new2 !== void 0 ? _PROMPTS$i18n$add_new2 : 'Add new option';
        input.dataset.optionGroup = field.type;
        fieldset.appendChild(input);
  ...
  init_intervalevent: function init_intervalevent(thisClass) {
    ...
    document.querySelectorAll('.popup_step__header__remove:not([data-handled])').forEach(function (el, ei) {
      el.dataset.handled = true;
      el.addEventListener('click', function (event) {
        var _PROMPTS$i18n$areusur, _PROMPTS$i18n42;
        event.preventDefault();
        if (confirm((_PROMPTS$i18n$areusur = (_PROMPTS$i18n42 = PROMPTS.i18n) === null || _PROMPTS$i18n42 === void 0 ? void 0 : _PROMPTS$i18n42.areusure) !== null && _PROMPTS$i18n$areusur !== void 0 ? _PROMPTS$i18n$areusur : 'Are you sure?')) {
    ...
    document.querySelectorAll('.do_repeater_field:not([data-handled])').forEach(function (el, ei) {
      el.dataset.handled = true;
      el.addEventListener('click', function (event) {
        var _el$dataset$isGroup, _el$dataset;
        event.preventDefault();
        PROMPTS.do_repeater(el, {}, (_el$dataset$isGroup = (_el$dataset = el.dataset) === null || _el$dataset === void 0 ? void 0 : _el$dataset.isGroup) !== null && _el$dataset$isGroup !== void 0 ? _el$dataset$isGroup : false);
      });
    });
    ...
    document.querySelectorAll('.single-repeater-option .input-group-append:not([data-handled])').forEach(function (trash) {
      ...
      trash.addEventListener('click', function (event) {
        var _PROMPTS$i18n$rusure, _PROMPTS$i18n43;
        if (trash.parentElement && confirm((_PROMPTS$i18n$rusure = (_PROMPTS$i18n43 = PROMPTS.i18n) === null || _PROMPTS$i18n43 === void 0 ? void 0 : _PROMPTS$i18n43.rusure) !== null && _PROMPTS$i18n$rusure !== void 0 ? _PROMPTS$i18n$rusure : 'Are you sure?')) {
    ...
    document.querySelectorAll('.single-repeater-option .form-control[type=text]:not([data-autocomplete-handled])').forEach(function (input) {
      ...
      if (!isNaN(input.value)) {
        ...
        if (row !== null && row !== void 0 && row.title) {
          input.value = PROMPTS.he.decode(row.title);
        }
      }
      var autocomplete = new thisClass.Awesomplete(input, {
        list: PROMPTS.lastJson.accessories.map(function (row) {
          return {
            label: row.title,
            value: row.ID,
  ...
  do_repeater: function do_repeater(el, row, groupAt) {
    var _row$label, _row$next, _row$cost, _row$imageUrl, _PROMPTS$i18n$select_4, _PROMPTS$i18n44, _row$imageUrl2, _row$imageUrl3, _row$image, _row$imageUrl4, _row$thumbUrl, _PROMPTS$i18n$select_5, _PROMPTS$i18n45, _row$thumbUrl2, _row$thumbUrl3, _row$thumb, _row$thumbUrl4;
    ...
    input.setAttribute('value', (_row$label = row === null || row === void 0 ? void 0 : row.label) !== null && _row$label !== void 0 ? _row$label : '');
    input.type = 'text';
    ...
    hidden.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.next';
    hidden.setAttribute('value', (_row$next = row === null || row === void 0 ? void 0 : row.next) !== null && _row$next !== void 0 ? _row$next : '');
    hidden.type = 'number';
    config.appendChild(hidden);
    hidden = document.createElement('input');
    hidden.classList.add('form-control', 'w-half');
    hidden.placeholder = 'Additional cost';
    hidden.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.cost';
    hidden.setAttribute('value', (_row$cost = row === null || row === void 0 ? void 0 : row.cost) !== null && _row$cost !== void 0 ? _row$cost : '');
    hidden.type = 'number';
    config.appendChild(hidden);
    image = document.createElement('button');
    image.classList.add('form-control', 'w-half', 'imglibrary');
    image.placeholder = 'Image';
    image.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.imageUrl';
    image.setAttribute('value', (_row$imageUrl = row === null || row === void 0 ? void 0 : row.imageUrl) !== null && _row$imageUrl !== void 0 ? _row$imageUrl : 'Select Image');
    image.type = 'button';
    image.dataset.innertext = image.innerHTML = (_PROMPTS$i18n$select_4 = (_PROMPTS$i18n44 = PROMPTS.i18n) === null || _PROMPTS$i18n44 === void 0 ? void 0 : _PROMPTS$i18n44.select_image) !== null && _PROMPTS$i18n$select_4 !== void 0 ? _PROMPTS$i18n$select_4 : 'Select image';
    image.innerHTML = ((_row$imageUrl2 = row === null || row === void 0 ? void 0 : row.imageUrl) !== null && _row$imageUrl2 !== void 0 ? _row$imageUrl2 : '') == '' ? image.innerHTML : image.innerHTML + ' (' + ((_row$imageUrl3 = row === null || row === void 0 ? void 0 : row.imageUrl) !== null && _row$imageUrl3 !== void 0 ? _row$imageUrl3 : '').split(/[\\/]/).pop() + ')';
    config.appendChild(image);
    hidden = document.createElement('input');
    hidden.classList.add('form-control');
    hidden.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.image';
    hidden.type = 'hidden';
    hidden.setAttribute('value', (_row$image = row === null || row === void 0 ? void 0 : row.image) !== null && _row$image !== void 0 ? _row$image : '');
    config.appendChild(hidden);

    // Preview
    config.appendChild(PROMPTS.imagePreview((_row$imageUrl4 = row === null || row === void 0 ? void 0 : row.imageUrl) !== null && _row$imageUrl4 !== void 0 ? _row$imageUrl4 : '', thisClass));
    image = document.createElement('button');
    image.classList.add('form-control', 'w-half', 'imglibrary');
    image.placeholder = 'Thumbnail';
    image.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.thumbUrl';
    image.setAttribute('value', (_row$thumbUrl = row === null || row === void 0 ? void 0 : row.thumbUrl) !== null && _row$thumbUrl !== void 0 ? _row$thumbUrl : 'Select a thumbnail');
    image.type = 'button';
    image.dataset.innertext = image.innerHTML = (_PROMPTS$i18n$select_5 = (_PROMPTS$i18n45 = PROMPTS.i18n) === null || _PROMPTS$i18n45 === void 0 ? void 0 : _PROMPTS$i18n45.select_thumbnail) !== null && _PROMPTS$i18n$select_5 !== void 0 ? _PROMPTS$i18n$select_5 : 'Select thumbnail';
    image.innerHTML = ((_row$thumbUrl2 = row === null || row === void 0 ? void 0 : row.thumbUrl) !== null && _row$thumbUrl2 !== void 0 ? _row$thumbUrl2 : '') == '' ? image.innerHTML : image.innerHTML + ' (' + ((_row$thumbUrl3 = row === null || row === void 0 ? void 0 : row.thumbUrl) !== null && _row$thumbUrl3 !== void 0 ? _row$thumbUrl3 : '').split(/[\\/]/).pop() + ')';
    config.appendChild(image);
    hidden = document.createElement('input');
    hidden.classList.add('form-control');
    hidden.name = (groupAt !== false ? 'groups.' + groupAt + '.options.' : 'options.') + order + '.thumb';
    hidden.type = 'hidden';
    hidden.setAttribute('value', (_row$thumb = row === null || row === void 0 ? void 0 : row.thumb) !== null && _row$thumb !== void 0 ? _row$thumb : '');
    config.appendChild(hidden);
    config.appendChild(PROMPTS.imagePreview((_row$thumbUrl4 = row === null || row === void 0 ? void 0 : row.thumbUrl) !== null && _row$thumbUrl4 !== void 0 ? _row$thumbUrl4 : '', thisClass));
  ...
  do_group_repeater: function do_group_repeater(el, group) {
    var _PROMPTS$i18n$field_t, _PROMPTS$i18n46, _PROMPTS$i18n$layer_o, _PROMPTS$i18n47, _group$layer, _PROMPTS$i18n$row_tit, _PROMPTS$i18n48, _group$title, _PROMPTS$i18n$add_new3, _PROMPTS$i18n49, _group$type2, _group$options;
    ...
    label = document.createElement('label');
    label.classList.add('form-label');
    label.innerHTML = (_PROMPTS$i18n$field_t = (_PROMPTS$i18n46 = PROMPTS.i18n) === null || _PROMPTS$i18n46 === void 0 ? void 0 : _PROMPTS$i18n46.field_type) !== null && _PROMPTS$i18n$field_t !== void 0 ? _PROMPTS$i18n$field_t : 'Field type';
    ...
    select.name = 'groups.' + groupAt + '.type';
    select.id = 'group-type-' + groupAt;
    ['Checkbox', 'Radio'].forEach(function (value) {
      var _group$type;
      option = document.createElement('option');
      option.value = value.toLowerCase();
      if (((_group$type = group === null || group === void 0 ? void 0 : group.type) !== null && _group$type !== void 0 ? _group$type : '') == option.value) {
    ...
    label = document.createElement('label');
    label.classList.add('form-label');
    label.innerHTML = (_PROMPTS$i18n$layer_o = (_PROMPTS$i18n47 = PROMPTS.i18n) === null || _PROMPTS$i18n47 === void 0 ? void 0 : _PROMPTS$i18n47.layer_order) !== null && _PROMPTS$i18n$layer_o !== void 0 ? _PROMPTS$i18n$layer_o : 'Layer Order';
    label.setAttribute('for', 'group-layer-' + order);
    body.appendChild(label);
    input = document.createElement('input');
    input.classList.add('form-control');
    input.name = 'groups.' + groupAt + '.layer';
    ...
    label = document.createElement('label');
    label.classList.add('form-label');
    label.innerHTML = (_PROMPTS$i18n$row_tit = (_PROMPTS$i18n48 = PROMPTS.i18n) === null || _PROMPTS$i18n48 === void 0 ? void 0 : _PROMPTS$i18n48.row_title) !== null && _PROMPTS$i18n$row_tit !== void 0 ? _PROMPTS$i18n$row_tit : 'Row title';
    label.setAttribute('for', 'group-title-' + order);
    body.appendChild(label);
    input = document.createElement('input');
    input.classList.add('form-control');
    input.name = 'groups.' + groupAt + '.title';
    ...
    input.type = 'button';
    input.dataset.order = 0;
    input.dataset.isGroup = groupAt;
    input.innerHTML = (_PROMPTS$i18n$add_new3 = (_PROMPTS$i18n49 = PROMPTS.i18n) === null || _PROMPTS$i18n49 === void 0 ? void 0 : _PROMPTS$i18n49.add_new_option) !== null && _PROMPTS$i18n$add_new3 !== void 0 ? _PROMPTS$i18n$add_new3 : 'Add new option';
    input.dataset.optionGroup = (_group$type2 = group === null || group === void 0 ? void 0 : group.type) !== null && _group$type2 !== void 0 ? _group$type2 : '';
    body.appendChild(input);
    Object.values((_group$options = group === null || group === void 0 ? void 0 : group.options) !== null && _group$options !== void 0 ? _group$options : []).forEach(function (option) {
      PROMPTS.do_repeater(input, option, groupAt);
    });
  ...
  imagePreview: function imagePreview(src, thisClass) {
    var _PROMPTS$i18n$remove2, _PROMPTS$i18n50;
    var cross,
      preview,
      image,
      name = '';
    ...
    cross = document.createElement('div');
    cross.classList.add('dashicons-before', 'dashicons-dismiss');
    cross.title = (_PROMPTS$i18n$remove2 = (_PROMPTS$i18n50 = PROMPTS.i18n) === null || _PROMPTS$i18n50 === void 0 ? void 0 : _PROMPTS$i18n50.remove) !== null && _PROMPTS$i18n$remove2 !== void 0 ? _PROMPTS$i18n$remove2 : 'Remove';
...
__webpack_require__.r(__webpack_exports__);
// const icons = {
//     misc: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="-9.5 0 32 32" fill="#e63f51" version="1.1"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>record</title><path d="M2.656 11.25v-2.969c0-1.906 1.719-3.5 3.906-3.5 2.156 0 3.906 1.594 3.906 3.5v2.969h-7.813zM13.188 11.438v5.969c-1.281 3.5-5.063 4.031-5.063 4.031v3.969h4.156v1.781h-11.438v-1.781h4.188v-3.969s-3.75-0.531-5.031-4.031v-5.969l1.531-0.719v5.438s0.469 3.656 5.031 3.656 5.094-3.656 5.094-3.656v-5.438zM10.469 12.281v2.688c0 1.906-1.75 3.5-3.906 3.5-2.188 0-3.906-1.594-3.906-3.5v-2.688h7.813z"></path></g></svg>`,
//     play: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M21.4086 9.35258C23.5305 10.5065 23.5305 13.4935 21.4086 14.6474L8.59662 21.6145C6.53435 22.736 4 21.2763 4 18.9671L4 5.0329C4 2.72368 6.53435 1.26402 8.59661 2.38548L21.4086 9.35258Z" fill="#e63f51"></path></g></svg>`,
...
//     stop: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#e63f51"><rect x="5" y="5" width="16" height="16" rx="1" style="fill: none;stroke: #e63f51;stroke-linecap: round;stroke-linejoin: round;stroke-width: 2;"/></svg>`,
//     upload: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M12.5535 2.49392C12.4114 2.33852 12.2106 2.25 12 2.25C11.7894 2.25 11.5886 2.33852 11.4465 2.49392L7.44648 6.86892C7.16698 7.17462 7.18822 7.64902 7.49392 7.92852C7.79963 8.20802 8.27402 8.18678 8.55352 7.88108L11.25 4.9318V16C11.25 16.4142 11.5858 16.75 12 16.75C12.4142 16.75 12.75 16.4142 12.75 16V4.9318L15.4465 7.88108C15.726 8.18678 16.2004 8.20802 16.5061 7.92852C16.8118 7.64902 16.833 7.17462 16.5535 6.86892L12.5535 2.49392Z" fill="#e63f51"></path><path d="M3.75 15C3.75 14.5858 3.41422 14.25 3 14.25C2.58579 14.25 2.25 14.5858 2.25 15V15.0549C2.24998 16.4225 2.24996 17.5248 2.36652 18.3918C2.48754 19.2919 2.74643 20.0497 3.34835 20.6516C3.95027 21.2536 4.70814 21.5125 5.60825 21.6335C6.47522 21.75 7.57754 21.75 8.94513 21.75H15.0549C16.4225 21.75 17.5248 21.75 18.3918 21.6335C19.2919 21.5125 20.0497 21.2536 20.6517 20.6516C21.2536 20.0497 21.5125 19.2919 21.6335 18.3918C21.75 17.5248 21.75 16.4225 21.75 15.0549V15C21.75 14.5858 21.4142 14.25 21 14.25C20.5858 14.25 20.25 14.5858 20.25 15C20.25 16.4354 20.2484 17.4365 20.1469 18.1919C20.0482 18.9257 19.8678 19.3142 19.591 19.591C19.3142 19.8678 18.9257 20.0482 18.1919 20.1469C17.4365 20.2484 16.4354 20.25 15 20.25H9C7.56459 20.25 6.56347 20.2484 5.80812 20.1469C5.07435 20.0482 4.68577 19.8678 4.40901 19.591C4.13225 19.3142 3.9518 18.9257 3.85315 18.1919C3.75159 17.4365 3.75 16.4354 3.75 15Z" fill="#e63f51"></path></g></svg>`,
...
//     mail: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M3 8L10.8906 13.2604C11.5624 13.7083 12.4376 13.7083 13.1094 13.2604L21 8M5 19H19C20.1046 19 21 18.1046 21 17V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19Z" stroke="#e63f51" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
//     skip: `<svg width="32px" height="32px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><path d="M19 5V19M7.59951 17.9204L13.4383 13.2494C13.9721 12.8223 14.239 12.6088 14.3357 12.3508C14.4204 12.1246 14.4204 11.8754 14.3357 11.6492C14.239 11.3912 13.9721 11.1777 13.4383 10.7506L7.59951 6.07961C6.76734 5.41387 6.35125 5.081 6.00108 5.08063C5.69654 5.0803 5.40845 5.21876 5.21846 5.45677C5 5.73045 5 6.2633 5 7.329V16.671C5 17.7367 5 18.2695 5.21846 18.5432C5.40845 18.7812 5.69654 18.9197 6.00108 18.9194C6.35125 18.919 6.76734 18.5861 7.59951 17.9204Z" stroke="#e63f51" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
// };
var icons = {

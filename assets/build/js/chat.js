...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chatinterface__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chatinterface */ "./src/js/chatinterface/index.js");
/* harmony import */ var _sass_chat_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../sass/chat.scss */ "./src/sass/chat.scss");
/* harmony import */ var _sass_chat_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_sass_chat_scss__WEBPACK_IMPORTED_MODULE_1__);
// Scripts
...
/**
 * Javascript hooks inspired from wordpress hooks
 * 
 * @param {string} [o] Hook tag string
 * @param {int} [t] Priority of the function
 */
var Hooks = /*#__PURE__*/function () {
  ...
  return _createClass(Hooks, [{
    key: "add_action",
    value: function add_action(action, callable, priority, tag) {
      this.addHook('action', action, callable, priority, tag);
    }
  }, {
    key: "add_filter",
    value: function add_filter(action, callable, priority, tag) {
      this.addHook('filter', action, callable, priority, tag);
    }
  }, {
    key: "do_action",
    value: function do_action(action) {
      this.doHook('action', action, arguments);
    }
  }, {
    key: "apply_filters",
    value: function apply_filters(action) {
      return this.doHook('filter', action, arguments);
    }
  }, {
    key: "remove_action",
    value: function remove_action(action, tag) {
      this.removeHook('action', action, tag);
    }
  }, {
    key: "remove_filter",
    value: function remove_filter(action, priority, tag) {
      this.removeHook('filter', action, priority, tag);
    }
  }, {
    key: "addHook",
    value: function addHook(hookType, action, callable, priority, tag) {
    ...
    key: "doHook",
    value: function doHook(hookType, action, args) {
      ...
      if (undefined != this.hooks[hookType][action]) {
        ...
        hooks.forEach(function (hookItem) {
          if (_typeof(hookItem === null || hookItem === void 0 ? void 0 : hookItem.callable) === 'object' && hookItem.callable[1] && hookItem.callable[1] in hookItem.callable[0]) {
    ...
    key: "removeHook",
    value: function removeHook(hookType, action, priority, tag) {
      if (undefined != this.hooks[hookType][action]) {
        var hooks = this.hooks[hookType][action];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _interface__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./interface */ "./src/js/chatinterface/interface.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var Chat = /*#__PURE__*/function (_Interface) {
  function Chat() {
    var _this;
    ...
    // 
    window.Chat = _this;
    _this.init_chat_hooks();
    return _this;
  }
  _inherits(Chat, _Interface);
  return _createClass(Chat, [{
    key: "read_file",
    value: function read_file(path) {
    ...
    key: "get_models",
    value: function get_models() {
      var _this2 = this;
      return new Promise(function (resolve, reject) {
        // 
        fetch("".concat(_this2.base_url, "/models")).then(function (res) {
          return res.json();
        }).then(function (res) {
          return resolve(res);
        }).catch(function (err) {
    ...
    key: "init_chat_hooks",
    value: function init_chat_hooks() {
      var _this3 = this;
      this.add_action('chat_register_history', function (response, prompt, images, data) {
        var userMsg = data.messages.pop();
        if (!(userMsg !== null && userMsg !== void 0 && userMsg.id)) {
          userMsg.id = Date.now();
        }
        _this3.history.push(userMsg);
        var resMsg = response.data.choices[0].message;
        if (!(resMsg !== null && resMsg !== void 0 && resMsg.id)) {
          resMsg.id = userMsg.id + 1;
        }
        _this3.history.push(resMsg);
        _this3.do_action('print_messages', [resMsg], response, prompt, images, data);
      }, 10, 4);
      this.add_action('chat_stream_chunk', function (chunk, prompt, images, data) {
        console.log(chunk, prompt, images, data);
      }, 10, 4);
    }
  }, {
    key: "imageUrlToBase64",
    value: function imageUrlToBase64(imageUrl) {
      return new Promise(function (resolve, reject) {
        var img = new Image();
        // img.cors = 'anonymous';
        ...
        img.onerror = function () {
          reject(new Error("Error loading image: ".concat(imageUrl)));
        };
        img.src = imageUrl;
      });
    }
    ...
    key: "get_completions",
    value: function get_completions(text) {
      var _this4 = this;
      ...
      return new Promise(/*#__PURE__*/function () {
        var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
          var url, messages, data, chunks;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                url = "".concat(_this4.base_url, "/chat/completions");
                if (_this4 !== null && _this4 !== void 0 && _this4.models) {
                  _context2.next = 4;
                  break;
                }
                _context2.next = 4;
                return _this4.get_models().then(function (json) {
                  return json.data;
              ...
              case 4:
                messages = [{
                  "role": "system",
                  "content": prompt.trim() == '' ? "You are a helpful, smart, kind, and efficient AI assistant. You always fulfill the user's requests to the best of your ability." : prompt
                }].concat(_toConsumableArray(_this4.history.map(function (chat) {
                  return {
                    role: chat.role,
                ...
                _context2.next = 9;
                return images.map(/*#__PURE__*/function () {
                    ...
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 4;
                          return _this4.imageUrlToBase64(image);
                        case 4:
                          dataImage = _context.sent;
                        case 5:
                          return _context.abrupt("return", dataImage);
                        case 6:
                        case "end":
              ...
              case 9:
                ...
                if (data !== null && data !== void 0 && data.stream) {
                  chunks = {
                    role: messages.at(-2).role,
                    content: ''
                  };
                  _this4.do_action('getting_chunks', [chunks]);
                }
                _this4.axios.post(url, JSON.stringify(_this4.apply_filters('chat_completion_args', data, prompt, images)), {
                  responseType: 'stream',
                  headers: {
                    'Content-Type': 'application/json'
                  },
                  onUploadProgress: function onUploadProgress(_ref3) {
                    var progress = _ref3.progress,
                      rate = _ref3.rate;
                    _this4.do_action('on_upload_progress', data, progress, rate);
                    console.log("Upload [".concat((progress * 100).toFixed(2), "%]: ").concat((rate / 1024).toFixed(2), "KB/s"));
                  }
                }).then(function (response) {
                  if (data !== null && data !== void 0 && data.stream) {
                    var reader = response.data.getReader();
                    var decoder = new TextDecoder('utf-8');
                    var result = '';
                    var _readStream = function readStream() {
                      reader.read().then(function (_ref4) {
                        var done = _ref4.done,
                          value = _ref4.value;
                        if (done) {
                          _this4.do_action('chat_completion_response', result, prompt, images, data);
                          _this4.do_action('chat_register_history', result, prompt, images, data);
                          _this4.do_action('cleanup_chunks', result);
                          resolve(result);
                          return;
                        }
                        ...
                        result += chunk;
                        _this4.do_action('chat_stream_chunk', chunk, prompt, images, data);
                        _readStream();
                      }).catch(function (error) {
                        return reject(error);
                      });
                    ...
                    _this4.do_action('chat_completion_response', response, prompt, images, data);
                    _this4.do_action('chat_register_history', response, prompt, images, data);
                    _this4.do_action('cleanup_chunks', response.data.choices[0].message);
    ...
    value: function askQuestion() {
      var _this5 = this;
      var ans = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var ask = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      ask = prompt(ans == false ? 'Ask Question' : "Your Question: ".concat(ask, "\n\nYour Answer: ").concat(ans));
      if (!ask || ask == '') {
        return;
      }
      if (ask.startsWith('/')) {
        if (ask.startsWith('/clear')) {
          ...
          fetch("http://testbed.local/wp-json/flutterwave/v1/filesystem?readfile=".concat(file_path)).then(function (data) {
            return data.json();
          }).then(function (data) {
            console.log(data.file_contents);
            _this5.history.push({
              role: 'assistant',
              content: "File contents for the path ".concat(file_path, " is: \n").concat(data.file_contents)
            });
            _this5.askQuestion();
          }).catch(function (err) {
            return console.error(err);
        ...
        this.get_completions(ask).then(function (data) {
          return _this5.askQuestion(data === null || data === void 0 ? void 0 : data.choices[0].message.content, ask);
        }).catch(function (err) {
          return console.error(err);
        });
      }
...
/***/ "./src/js/chatinterface/interface.js":
/*!*******************************************!*\
  !*** ./src/js/chatinterface/interface.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./post */ "./src/js/chatinterface/post.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
function _createClass(e, r, t) { return r && _defineProperties(e.prototype, r), t && _defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
...
var Interface = /*#__PURE__*/function (_Post) {
  function Interface() {
    var _this;
    _classCallCheck(this, Interface);
    _this = _callSuper(this, Interface);
    _this.axios = axios__WEBPACK_IMPORTED_MODULE_0__["default"];
    _this.base_url = "http://localhost:1234/v1";
    _this.elements = {};
    _this.init_frontend();
    _this.init_interface();
    _this.init_interface_hooks();
    return _this;
  }
  _inherits(Interface, _Post);
  return _createClass(Interface, [{
    key: "init_frontend",
    value: function init_frontend() {
    ...
    value: function init_interface() {
      ...
      w.fb.addEventListener('click', function (event) {
    ...
    key: "chat_message_body",
    value: function chat_message_body(body) {
      var _this3 = this;
      ...
      this.add_action('print_messages', function (messages) {
        var _messages;
        _this3.elements.reserved.appendChild(_this3.elements.chatPreScrn);
        if ((_messages = messages) !== null && _messages !== void 0 && _messages.role) {
          messages = [messages];
        }
        messages.map(function (message) {
          _this3.chat_message_block(message);
        });
      }, 0, 1);
      this.add_action('getting_chunks', function (messages) {
        var _messages2;
        _this3.elements.reserved.appendChild(_this3.elements.chatPreScrn);
        if ((_messages2 = messages) !== null && _messages2 !== void 0 && _messages2.role) {
          messages = [messages];
        }
        messages.map(function (message) {
    ...
    key: "chat_message_block",
    value: function chat_message_block(message) {
      var _this4 = this;
      var chat = {};
      chat.blk = document.createElement('div');
      chat.blk.classList.add('ct-blk');
      if (message.isChunked) {
        chat.blk.classList.add('ct-blk-chunks');
      }
      ...
      chat.msgCp.addEventListener('click', function (event) {
        event.preventDefault();
        event.stopPropagation();
        _this4.do_action('chat_message_pre_copy_message', chat, message);
        navigator.clipboard.writeText(_this4.apply_filters('chat_message_copy_message_text', chat, message));
        _this4.do_action('chat_message_copy_message', chat, message);
      });
      chat.msgActs.appendChild(chat.msgCp);
      // 
      chat.msgPen = document.createElement('div');
      chat.msgPen.classList.add('ct-i', 'ct-i-pn');
      chat.msgPen.addEventListener('click', function (event) {
        var _message$content;
        event.preventDefault();
        event.stopPropagation();
        _this4.do_action('chat_message_pre_shift_edit', chat, message);
        var txtArea = document.createElement('textarea');
        chat.msgBlk.innerHTML = '';
        txtArea.value = (_message$content = message === null || message === void 0 ? void 0 : message.content) !== null && _message$content !== void 0 ? _message$content : '';
        txtArea.addEventListener('keypress', function (event) {
          if (event.keyCode === 13 && event.shiftKey == false) {
            _this4.do_action('chat_message_pre_edit', chat, message);
            var text = _this4.apply_filters('chat_message_edit_text', txtArea.value, message, chat);
            txtArea.remove();
            chat.msgBlk.innerHTML = text;
            _this4.do_action('chat_message_edited', chat, message);
          }
        });
        chat.msgBlk.appendChild(txtArea);
        _this4.do_action('chat_message_shift_edit', chat, message);
      });
      chat.msgActs.appendChild(chat.msgPen);
      // 
      chat.msgTr = document.createElement('div');
      chat.msgTr.classList.add('ct-i', 'ct-i-tr');
      chat.msgTr.addEventListener('click', function (event) {
        event.preventDefault();
        event.stopPropagation();
        _this4.do_action('chat_message_pre_delete', chat, message);
        chat.blk.remove();
        _this4.do_action('chat_message_deleted', chat, message);
      });
      ...
      if (message !== null && message !== void 0 && message.isChunked) {
        this.elements.chatChunks = chat.blk;
      }
      return chat;
    }
  }, {
    key: "get_avater_image",
    value: function get_avater_image(role) {
    ...
    key: "init_interface_hooks",
    value: function init_interface_hooks() {
      var _this5 = this;
      this.add_action('cleanup_chunks', function (message) {
        _this5.elements.chatChunks.remove();
      });
      this.add_action('cleared_chat_history', function (message) {
        _this5.elements.chatBody.innerHTML = '';
        _this5.elements.chatBody.appendChild(_this5.elements.chatPreScrn);
      });
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hooks */ "./src/js/chatinterface/hooks.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var Post = /*#__PURE__*/function (_Hooks) {
  function Post() {
    var _this;
  ...
  return _createClass(Post, [{
        ...
        if (args.eventStream && !!window.EventSource) {
          ...
          $.ajax(_objectSpread({
            ...
            error: function error(jqXHR, status, err) {
              ...
              var errorText = PostClass.formatErrorText(err); // Refactored for clarity
    ...
    key: "extractMessage",
    value: function extractMessage(json) {
      var _json$data, _json$data2;
      return ((_json$data = json === null || json === void 0 ? void 0 : json.data) !== null && _json$data !== void 0 ? _json$data : false) && typeof json.data === 'string' ? json.data : typeof ((_json$data2 = json.data) === null || _json$data2 === void 0 ? void 0 : _json$data2.message) === 'string' ? json.data.message : false;
    }
  }, {
    key: "formatErrorText",
    value: function formatErrorText(err) {
...
}(_hooks__WEBPACK_IMPORTED_MODULE_0__["default"]);
